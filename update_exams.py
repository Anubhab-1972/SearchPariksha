...
3. If registration for this cycle is CLOSED (regardless of whether the exam has happened or not), search for when the registration opened THIS year, and add one year to predict when registration will open NEXT year.
...
- If registration is closed, predict next year's registration: "Expected Registration: August 2027"
