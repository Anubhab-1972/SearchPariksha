      ...
      item.innerHTML = `
        <div style="width: 100%;">
          ...
          <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            ${calBtnHtml}
            ${exam.syllabus_link === '' ? `<span style="display: inline-block; font-size: 0.85em; color: #856404; background: #fff3cd; border: 1px solid #ffc107; padding: 8px 12px; border-radius: 4px; font-weight: bold;">🔔 Official Website: To Be Announced</span>` : exam.syllabus_link ? `<a href="${exam.syllabus_link}" target="_blank" style="display: inline-block; font-size: 0.85em; color: white; background: #28a745; padding: 8px 12px; border-radius: 4px; text-decoration: none; font-weight: bold;">🌐 Official Website</a>` : ''}
          </div>
        </div>
      `;
